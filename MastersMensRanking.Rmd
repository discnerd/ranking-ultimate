...
```
```{r}
save(scores, teams, file=paste0("MastersMensScores",format(Sys.time(),"%Y %m %d"),".Rdata"))
```
...
```{r}
write.csv(rankedteams, paste("USAU Masters Men RW", format(Sys.time(),"%Y %m %d"),".csv",sep=""), row.names = TRUE)
