...
library(readr)
library(stringr)
oldmensScores <- load("MensScores2017 05 22.Rdata")
```
```{r pullScores}
indices <- c(248,338,292,266,325,77,255,477,514,108,291,400,112,438,24,47,55,116,327,473)
library(tidyverse)
library(rvest)
library(XML)
...
for( i in indices){
  ...
  for(j in 1:length(data$Links)){
    ...
    if( length(oppID) >0){
      if(filter(scores, Team1==teams$Team[i] & 
                Score1==data$For[j] &
                Team2==teams$Team[oppID] & 
                Score2==data$Against[j] & 
                Date==data$Date[j]) %>% count(Team2) == 0){
