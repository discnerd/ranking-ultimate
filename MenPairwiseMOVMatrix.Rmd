...
```
```{r}
load("AllMenScores2017 10 03.Rdata")
...
rankedteams  %>% filter(`Competition Level` == "Club") %>% select(Team, Index, Rating, Wins, Losses)
rankedteams  %>% filter(`Competition Level` == "Club") %>% select(Team, Index, Rating, Wins, Losses) %>% .$Index
```

```{r}
bids <- 1
indices <- c(589, 657, 598, 366, 768, 332, 226, 153, 377, 268, 300, 560, 699, 544, 656, 231)
