...
```
```{r}
save(scores, teams, file=paste0("Data/CollegeWomensScores",format(Sys.time(),"%Y %m %d"),".Rdata"))
```
...
```{r}
write.csv(rankedteams, paste("USAU College Women RW", format(Sys.time(),"%Y %m %d"),".csv",sep=""), row.names = TRUE)
