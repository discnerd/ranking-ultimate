...
```
```{r}
save(scores, teams, file=paste0("ClubWomensScores",format(Sys.time(),"%Y %m %d"),".Rdata"))
```
...
```{r}
write.csv(rankedteams, paste("USAU Club Women RW", format(Sys.time(),"%Y %m %d"),".csv",sep=""), row.names = TRUE)
